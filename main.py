...
class DiceApp(App):
    def build(self):
        ...
        self.is_animating = False  # Animasyon durumu kontrolü için bayrak
    ...
    def on_touch_down(self, instance, touch):
        # Animasyon devam ederken yeni tıklamaları engelle
    ...
    def animate_dice(self):
        # Animasyon başladığında bayrağı kaldır
        self.is_animating = True

        # Animasyon tamamlanma sayacı
        self.animation_complete_count = 0
        ...
        # Animasyon tamamlanma kontrolü için fonksiyon
        def on_animation_complete(*args):
            self.animation_complete_count += 1
            # Her iki animasyon da tamamlandığında bayrağı indir
            if self.animation_complete_count == 2:
                self.is_animating = False

        # Her iki animasyon için de tamamlama dinleyicisi ekle
        anim_in1.bind(on_complete=on_animation_complete)
        anim_in2.bind(on_complete=on_animation_complete)
